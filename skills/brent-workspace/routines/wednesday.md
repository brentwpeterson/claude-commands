...
- Note the subscriber count

### 2. TRIGGER: Schedule 2-Week Promotion Campaign
...
3. Run the promotion workflow per `linkedin-article-promotion.md`:
   ...
   - Schedule across platforms:
     ...
     - Bluesky: 6 posts (Days 1, 2, 5, 8, 11, 14)
     - Threads: 2 posts (Days 1, 7)
...
With newsletter handled, focus on Q1 Rocks:

1. Review ROCKS.md for current priorities
2. This is a good day for deep work (2 content pieces done for week)
3. Block 3-4 hours for rock progress
