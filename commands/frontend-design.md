...
1. **Identify the context** - What's being built, for whom, and why
2. **Choose a bold aesthetic direction** - Commit to a distinctive tone
3. **Implement production-grade code** - Functional, polished, memorable
4. **Refine every detail** - Typography, color, motion, spacing
